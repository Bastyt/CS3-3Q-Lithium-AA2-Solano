function callAFunction() {
    ...
    let exponentialPopulationGrowth = Math.round(initialPopulation * Math.pow(Math.E,rateOfGrowth*timeInHours));   
    let location = prompt("input the region/location of the monster: ");
